...
def get_parser():
    ...
    parser.add_argument(
        ...
        help='root directory containing ecgqa files (e.g., ecgqa/paraphrased/)'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dest", type=str, metavar="DIR", default="output",
    ...
    for fname in glob.iglob(os.path.join(dir_path, "**/*.json")):
        ...
        for i, sample in enumerate(data):
            ...
            for ecg_id in sample["ecg_id"]:
                if not os.path.join(get_ptbxl_data_path(ecg_id, ptbxl_data_dir)):
                    raise FileNotFoundError(
                        ...
                        f"again after removing {cache_path}."
                    )
